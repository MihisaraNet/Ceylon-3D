...
const pw = StyleSheet.create({
  box:         { backgroundColor: '#fafafa', borderRadius: 8, padding: 14, marginBottom: 14, borderWidth: 1, borderColor: '#eee' },
  barRow:      { flexDirection: 'row', gap: 6, marginBottom: 8 },
  bar:         { flex: 1, height: 4, borderRadius: 4 },
  barOk:       { backgroundColor: '#000' },
  barBad:      { backgroundColor: '#ddd' },
  strengthLabel:{ fontSize: 12, fontWeight: '700', color: '#555', marginBottom: 8 },
  row:         { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 4 },
  txt:         { fontSize: 13, color: '#666' },
  ok:          { color: '#000', fontWeight: '600' },
});
