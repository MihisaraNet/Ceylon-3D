...
const s = StyleSheet.create({
  ...
  cartBadge: { position: 'absolute', top: -4, right: -4, backgroundColor: '#0f172a', minWidth: 20, height: 20, borderRadius: 10, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#fafafa' },
  cartBadgeText: { color: '#ffffff', fontSize: 10, fontWeight: '800' },

  searchWrap: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#ffffff', marginHorizontal: 24, borderRadius: 16, paddingHorizontal: 16, height: 50, borderWidth: 1, borderColor: '#f1f5f9', marginBottom: 16 },
  ...
  catPill: { paddingHorizontal: 18, paddingVertical: 10, borderRadius: 20, backgroundColor: '#ffffff', borderWidth: 1, borderColor: '#f1f5f9' },
  ...
  /* Card */
  card: { width: CARD_WIDTH, backgroundColor: '#ffffff', borderRadius: 24, borderWidth: 1, borderColor: '#f1f5f9', overflow: 'hidden' },
  ...
  priceLabel: { fontSize: 13, color: '#64748b', fontWeight: '500', marginBottom: 16 },
  
  addBtn: { width: '100%', backgroundColor: '#0f172a', paddingVertical: 10, borderRadius: 12, alignItems: 'center' },
  ...
  retryBtn: { backgroundColor: '#0f172a', paddingHorizontal: 20, paddingVertical: 10, borderRadius: 12 },
